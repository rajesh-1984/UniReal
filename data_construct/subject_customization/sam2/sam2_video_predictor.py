...
from sam2.utils.misc import concat_points, fill_holes_in_mask_scores, load_video_frames, load_existing_frames
...
class SAM2VideoPredictor(SAM2Base):
    ...
    def init_state(
        ...
        if video_path is not None:
            ...
            images, video_height, video_width = load_existing_frames(
                frames_np_lst=video_frames,
                image_size=self.image_size,
                offload_video_to_cpu=offload_video_to_cpu,
                compute_device=compute_device,
            )
