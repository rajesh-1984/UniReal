...
if __name__ == '__main__':
    ...
    total_indexes = list(range(50)) # your processing part
    part_indexes = split_list(total_indexes, N, k)
    data_root = "/mnt/myworkspace/xic_space/data/frame_openvid/" # your data root
    save_root = "/mnt/myworkspace/xic_space/data/frame_openvid_annotation_test/" # your save root

    try:
        for part_i in part_indexes:
            data_dir = os.path.join(data_root, f'{part_i}/')
            save_dir = os.path.join(save_root, f'{part_i}/')
            os.makedirs(save_dir, exist_ok=True)

            image_names = [i for i in os.listdir(data_dir) if i.endswith('.png')]
